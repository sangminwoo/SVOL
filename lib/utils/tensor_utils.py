...
if __name__ == '__main__':
    ...
    test_data_3d = [torch.randn(10,3,224,224), torch.randn(5,3,224,224),
                    torch.randn(7,3,224,224), torch.randn(6,3,224,224)]
    print(pad_sequences_1d(test_data_3d, dtype=torch.float)[0].shape) # padded_seqs 4x10x3x224x224
    print(pad_sequences_1d(test_data_3d, dtype=torch.float)[1].shape) # mask 4x10